...
export default function LandingHero({ title,  videoUrl,  backgroundImageUrl }: Props) {
  return (
    <div>
      <div className="absolute -z-10 top-0 h-full w-full object-cover">
        ...
        <div style={`background-image:url(${backgroundImageUrl})`} className='hidden md:block absolute bg-right-bottom z-2 top-0 left-0 w-full h-full pointer-events-none bg-cover bg-no-repeat'></div>
        <div id="hero"
